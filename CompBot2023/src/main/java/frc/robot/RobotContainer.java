...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    GenericEntry rotateRobotTab = Shuffleboard.getTab("Rotate robot")
    .add("Rotation degrees", 0)
    .withWidget("Text View")
    .withPosition(1, 1)
    .withSize(2, 1)
    .getEntry();

    SmartDashboard.putData("Rotate robot", new RotateRobotCommand(m_driveSystem, 90));

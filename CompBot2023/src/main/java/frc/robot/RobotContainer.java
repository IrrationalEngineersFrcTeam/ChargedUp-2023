...
public class RobotContainer {
  ...
  private static RobotContainer m_robotContainer = new RobotContainer();
    ...
    private final Solenoid solenoid0 = new Solenoid(0, PneumaticsModuleType.CTREPCM, 0);
    private final Solenoid solenoid7 = new Solenoid(0, PneumaticsModuleType.CTREPCM, 7);
...
// Create some buttons
  ...
  public Solenoid getSolenoid(int module) {
    switch (module) {
      case 0:
      return solenoid0;
      case 7:
